...
$modversion['config'][$i]['default'] = 'image/gif|image/jpeg|image/pjpeg|image/x-png|image/png|application/x-zip-compressed|application/zip|application/rar|application/pdf|application/x-gtar|application/x-tar|application/msword|application/vnd.ms-excel|application/vnd.oasis.opendocument.text|application/vnd.oasis.opendocument.spreadsheet|application/vnd.oasis.opendocument.presentation|application/vnd.oasis.opendocument.graphics|application/vnd.oasis.opendocument.chart|application/vnd.oasis.opendocument.formula|application/vnd.oasis.opendocument.database|application/vnd.oasis.opendocument.image|application/vnd.oasis.opendocument.text-master';
$i++;
...
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 1;
$modversion['config'][$i]['options'] = array('_MI_biblioteca_TOPORDER1' => 1, '_MI_biblioteca_TOPORDER2' => 2, '_MI_biblioteca_TOPORDER3' => 3, '_MI_biblioteca_TOPORDER4' => 4, '_MI_biblioteca_TOPORDER5' => 5, '_MI_biblioteca_TOPORDER6' => 6, '_MI_biblioteca_TOPORDER7' => 7, '_MI_biblioteca_TOPORDER8' => 8);
$i++;
