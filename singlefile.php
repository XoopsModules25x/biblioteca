...
if (is_object($xoopsUser) && $xoopsUser->isAdmin($xoopsModule->mid())) {
    $adminlink = '<a href="' . XOOPS_URL . '/modules/biblioteca/admin/downloads.php?op=view_downloads&amp;downloads_lid=' . $_REQUEST['lid'] . '" title="' . _MD_BIBLIOTECA_EDITTHISDL . '"><img src="' . XOOPS_URL . '/modules/biblioteca/images/editicon.png" width="16px" height="16px" border="0" alt="'
                 . _MD_BIBLIOTECA_EDITTHISDL . '" /></a>';
}
...
if (($xoopsModuleConfig['usetellafriend'] == 1) and is_dir('../tellafriend')) {
    ...
    $tellafriend_texte = '<a target="_top" href="mailto:?subject=' . rawurlencode(sprintf(_MD_BIBLIOTECA_SINGLEFILE_INTFILEFOUND, $xoopsConfig['sitename'])) . '&amp;body=' . rawurlencode(sprintf(_MD_BIBLIOTECA_SINGLEFILE_INTFILEFOUND, $xoopsConfig['sitename']) . ':  ' . XOOPS_URL
                                                                                                                                                                                           . '/modules/biblioteca/singlefile.php?lid=' . $_REQUEST['lid']) . '">' . _MD_BIBLIOTECA_SINGLEFILE_TELLAFRIEND
                         . '</a>';
}
