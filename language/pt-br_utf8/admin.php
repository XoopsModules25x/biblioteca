...
define("_AM_biblioteca_IMPORT_WARNING","<span style='color:#FF0000; font-size:16px; font-weight:bold'>Atenção !</span><br><br> Com a importação vai apagar todos os dados em biblioteca.<br><br> É altamente recomendado que você faça um backup dos seus dados, também do seu site<br><br>TDM não é responsável se você perder seus dados.");
