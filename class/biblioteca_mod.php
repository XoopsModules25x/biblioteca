...
class biblioteca_mod extends XoopsObject
{
// constructor
...
class bibliotecabiblioteca_modHandler extends XoopsPersistableObjectHandler 
{
	function __construct(&$db) 
	{
		parent::__construct($db, "biblioteca_mod", 'biblioteca_mod', 'requestid', 'lid');
    }
}
?>
