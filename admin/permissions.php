...
echo "<form method='post' name='fselperm' action='permissions.php'><table border='0'><tr><td><select name='permission' onChange='document.fselperm.submit()'><option value='1'" . $selected[0] . '>' . _AM_BIBLIOTECA_PERM_VIEW . "</option><option value='2'" . $selected[1] . '>'
     . _AM_BIBLIOTECA_PERM_SUBMIT . "</option><option value='3'" . $selected[2] . '>' . _AM_BIBLIOTECA_PERM_DOWNLOAD . "</option><option value='4'" . $selected[3] . '>' . _AM_BIBLIOTECA_PERM_AUTRES . "</option></select></td></tr><tr><td><input type='submit' name='go'></tr></table></form>";
