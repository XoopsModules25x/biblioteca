...
switch ($op) {
    ...
    case 'list':
        ...
        echo ' | ';
        echo $op == 'list' && $statut_menu == 0 ? _AM_BIBLIOTECA_DOWNLOADS_WAIT . ($downloads_waiting == 0 ? '' : ' (<span style="color : Red">' . $downloads_waiting . '</span>)') : '<a href="downloads.php?op=list&statut_display=0">' . _AM_BIBLIOTECA_DOWNLOADS_WAIT . ($downloads_waiting
        ...
        if ($numrows > 0) {
            ...
            echo _AM_BIBLIOTECA_TRIPAR . "<select name=\"document_tri\" id=\"document_tri\" onchange=\"location='" . XOOPS_URL . '/modules/' . $xoopsModule->dirname()
            ...
            echo '</select> ';
            echo _AM_BIBLIOTECA_ORDER . "<select name=\"order_tri\" id=\"order_tri\" onchange=\"location='" . XOOPS_URL . '/modules/' . $xoopsModule->dirname()
            ...
            foreach (array_keys($downloads_arr) as $i) {
                ...
                echo '<td align="center">';
                echo($statut_display == 1 ? '<a href="downloads.php?op=lock_status&downloads_lid=' . $i . '"><img src="./../images/icon/lock.png" border="0" alt="' . _AM_BIBLIOTECA_FORMLOCK . '" title="' . _AM_BIBLIOTECA_FORMLOCK . '"></a> ' : '<a href="downloads.php?op=update_status&downloads_lid='
                                                                                                                                                                                                                                                    . $i
                                                                                                                                                                                                                                                    . '"><img src="./../images/icon/renew_mini.gif" border="0" alt="'
                                                                                                                                                                                                                                                    . _AM_BIBLIOTECA_FORMVALID . '" title="'
                                                                                                                                                                                                                                                    . _AM_BIBLIOTECA_FORMVALID . '"></a> ');
    ...
    case 'del_downloads':
        ...
        if (isset($_REQUEST['ok']) && $_REQUEST['ok'] == 1) {
            ...
            echo $op == 'list' && $statut_menu == 0 ? _AM_BIBLIOTECA_DOWNLOADS_WAIT . ($downloads_waiting == 0 ? '' : ' (<span style="color : Red">' . $downloads_waiting . '</span>)') : '<a href="downloads.php?op=list&statut_display=0">' . _AM_BIBLIOTECA_DOWNLOADS_WAIT . ($downloads_waiting
                                                                                                                                                                                          ...
                                                                                                                                                                                          . '</a>';
            echo '</div><br>';
            xoops_confirm(array('ok' => 1, 'downloads_lid' => $downloads_lid, 'op' => 'del_downloads'), $_SERVER['REQUEST_URI'],
                          sprintf(_AM_BIBLIOTECA_FORMSUREDEL, $obj->getVar('title')) . '<br><br>' . _AM_BIBLIOTECA_FORMWITHFILE . ' <b><a href="' . $obj->getVar('url') . '">' . $obj->getVar('url') . '</a></b><br>');
        }
        break;
    ...
    case 'view_downloads':
        ...
        echo '<a href="downloads.php?op=edit_downloads&downloads_lid=' . $downloads_lid . '"><img src="../images/icon/edit_mini.gif" alt="' . _AM_BIBLIOTECA_FORMEDIT . '" title="' . _AM_BIBLIOTECA_FORMEDIT . '"></a> <a href="downloads.php?op=del_downloads&downloads_lid=' . $downloads_lid . '">
        ...
        echo '</b><br><br></td></tr>';
        echo '<tr><td><b>' . _AM_BIBLIOTECA_DOWNLOADS_VOTE_USER . '</b></td>' . '<td><b>' . _AM_BIBLIOTECA_DOWNLOADS_VOTE_IP . '</b></td>' . '<td align="center"><b>' . _AM_BIBLIOTECA_FORMRATING . '</b></td>' . '<td><b>' . _AM_BIBLIOTECA_FORMDATE . '</b></td>' . '<td align="center"><b>'
             . _AM_BIBLIOTECA_FORMDEL . '</b></td></tr>';
        ...
        echo '</b><br><br></td></tr>';
        echo '<tr><td colspan="2"><b>' . _AM_BIBLIOTECA_DOWNLOADS_VOTE_IP . '</b></td>' . '<td align="center"><b>' . _AM_BIBLIOTECA_FORMRATING . '</b></td>' . '<td><b>' . _AM_BIBLIOTECA_FORMDATE . '</b></td>' . '<td align="center"><b>' . _AM_BIBLIOTECA_FORMDEL . '</b></td></tr>';
        foreach (array_keys($downloadsvotedata_arr) as $i) {
            echo '<tr>';
